...
static const char qt_meta_stringdata_ProgressDialog[] = {
    "ProgressDialog\0operationCancelled()\0"
    "\0setText(QString)\0newText\0"
    "setCurrentValue(int)\0value\0"
...
void ProgressDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->operationCancelled(); break;
        case 1: _t->setText((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 2: _t->setCurrentValue((*reinterpret_cast< int(*)>(_a[1]))); break;
...
// SIGNAL 0
void ProgressDialog::operationCancelled()
{
