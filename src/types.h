...
const QString progNameVer = progName + " 1.0.0b";
...
const QVector<QRgb> defaultRgba = {
    qRgba(0x00, 0x00, 0x00, 0x00),
    qRgba(0xf0, 0xf0, 0xf0, 0x00),
    qRgba(0xcc, 0xcc, 0xcc, 0x00),
    qRgba(0x99, 0x99, 0x99, 0x00),
    qRgba(0x33, 0x33, 0xfa, 0x00),
    qRgba(0x11, 0x11, 0xbb, 0x00),
    qRgba(0xfa, 0x33, 0x33, 0x00),
    qRgba(0xbb, 0x11, 0x11, 0x00),
    qRgba(0x33, 0xfa, 0x33, 0x00),
    qRgba(0x11, 0xbb, 0x11, 0x00),
    qRgba(0xfa, 0xfa, 0x33, 0x00),
    qRgba(0xbb, 0xbb, 0x11, 0x00),
    qRgba(0xfa, 0x33, 0xfa, 0x00),
    qRgba(0xbb, 0x11, 0xbb, 0x00),
    qRgba(0x33, 0xfa, 0xfa, 0x00),
    qRgba(0x11, 0xbb, 0xbb, 0x00)
};
